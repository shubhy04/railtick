				...
				<form action="trainbwstn" method="post">
					<div class="form-group">
						<label for="fromStation">From Station:</label> <input type="text"
							name="fromstation" class="form-control" id="fromStation"
							placeholder="Enter From Station" required> <i
							class="fas fa-train"></i>
					</div>
					<div class="form-group">
						<label for="toStation">To Station:</label> <input type="text"
							name="tostation" class="form-control" id="toStation"
							placeholder="Enter To Station" required> <i
							class="fas fa-train"></i>
					</div>
