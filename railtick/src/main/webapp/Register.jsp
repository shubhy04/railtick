...
body {
	background:
		url('https://img.freepik.com/free-photo/old-city-view_1417-1737.jpg?t=st=1710060682~exp=1710064282~hmac=efb7f3a109df4dd107540f78b4d28c27e760072b3565b8b72c3e2af374eef09e&w=900')
		fixed;
					...
					<li class="nav-item dropdown"><a
						...
						<div class="dropdown-menu" aria-labelledby="loginDropdown">
							<a class="dropdown-item" href="Login.jsp">User Login</a> <a
								class="dropdown-item" href="AdminLogin.jsp">Admin Login</a>
						</div></li>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="userreg" method="post" onsubmit="return validateForm()">
                        <div class="form-row">
                            <div class="form-group col-md-6 form-group-email">
							...
							<div class="form-group">
								<label for="phone">Contact:</label> <input type="text"
									class="form-control" id="phone" name="phoneno"
									placeholder="Enter your Contact Number" required>
							</div>
							<div class="form-group form-check">
								<input type="checkbox" class="form-check-input" id="termsCheck"
									required> <label class="form-check-label"
									for="termsCheck">I accept the terms and conditions</label>
							</div>
