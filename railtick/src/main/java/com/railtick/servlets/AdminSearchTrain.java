...
/**
 * Servlet implementation class AdminSearchTrain
 */
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			if (train != null) {
				...
				rd.include(req, res);
				pw.println("<div class='title'><p class='me'>Searched Train Detail</p></div>");
				...
				RequestDispatcher rd = req.getRequestDispatcher("AdminSearchTrain.jsp");
				rd.include(req, res);
				pw.println("<div class='content'><p class='error-message'>Train No." + trainNo + " is Not Available !</p></div>");
				pw.println("<div class='content' style='text-align: center;'>"
						+ "<form><input type='button' class='goback-btn' value='Go Back' "
						+ "onclick='history.back()'></form></div>");
			}
		} catch (Exception e) {
